      ...
      <div v-else-if="qType==4" >
        ...
        <div v-if="answer.contentArray!==null">
          <el-form-item :label="item.prefix" :key="item.prefix"  v-for="item in question.items"  label-width="50px" style="margin-top: 10px;margin-bottom: 10px;">
            <div v-html="answer.contentArray[item.prefix-1]"  class="question-answer-show" />
          </el-form-item>
        </div>
      </div>
      <div v-else-if="qType==5">
        <div class="q-title" v-html="question.title"/>
        <div v-html="answer.content" class="question-answer-show"/>
      </div>
      <div v-if="!qHideAnswer">
        ...
        <div class="question-answer-show-item" style="display: flex">
          <span class="question-show-item">正确答案：</span>
           <div style="flex: 1">
             ...
             <span v-if="qType==4">
             <div v-for="item in question.correctArray" :key="item" v-html="item" />
          </span>
           </div>
        </div>
      </div>
