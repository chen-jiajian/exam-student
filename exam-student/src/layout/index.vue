  ...
  <el-container>
    <el-header height="61" class="student-header">
      <div class="head-user">
        <el-dropdown trigger="click" placement="bottom">
          <el-badge :is-dot="messageCount!==0" >
            <el-avatar  class="el-dropdown-avatar" size="medium"  :src="imagePath===null|| imagePath === '' ? require('@/assets/avatar.png') : imagePath"></el-avatar>
          </el-badge>
      ...
      <el-menu class="el-menu-title" mode="horizontal" :default-active="defaultUrl" :router="true">
        ...
        <el-menu-item index="/special/index">专题训练</el-menu-item>
      ...
      <div>
        <a href="/"><img src="@/assets/logo.png" height="56" style="margin-left: 15px;"/></a>
      </div>
    </el-header>
