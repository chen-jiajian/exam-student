...
<div>
  ...
  <el-container  class="app-item-contain">
    <el-header class="align-center">
      <h1>{{form.name}}</h1>
      <div>
        <span class="question-title-padding">试卷得分：{{answer.status == 1 && form.hideScore ? '*' : answer.score}}</span>
        ...
        <el-row :key="index"  v-for="(titleItem,index) in form.titleItems">
          ...
          <el-card class="exampaper-item-box" v-if="titleItem.questionItems.length!==0">
            <el-form-item :key="questionItem.itemOrder" :label="questionItem.itemOrder+'.'"
              ...
              <QuestionAnswerShow :qType="questionItem.questionType" :question="questionItem"  :answer="answer.answerItems[questionItem.itemOrder-1]" :qHideAnswer="answer.status == 1 && form.hideAnswer"/>
            </el-form-item>
          </el-card>
        </el-row>
      </el-form>
...
import { formatSeconds, disableEvent } from '@/utils'
